...
abc2svg.MIDI={do_midi:function(parm){function abc_b40(p){var pit,acc=0,i=0
...
function mid_pit(p){var b40,pit=p
p=(pit/12)|0
pit=pit%12;b40=p*40+abc2svg.isb40[pit]+2
return{pit:abc2svg.b40p(b40),acc:abc2svg.b40a(b40)}}
function tb40(qs){var i,n1=[2,25,8,31,14,37,20,3,26,9,32,15,38,21,4,27,10,33,16,39],n2=[0,19,36,13,30,7,24,1,18,35,12,29,6,23,0,17],da=21-3*qs
...
abc.goto_tune()
if(abc.get_curvoice()){s=abc.new_block("midigch")
s.play=true
...
break
case"drummap":n=abc_b40(a[2])
v=Number(a[3])
if(!n||!v){abc.syntax(1,abc.errs.bad_val,"%%MIDI drummap")
break}
maps=abc.get_maps()
if(!maps.MIDIdrum)
maps.MIDIdrum={}
